 ...
 * @author Luiz-PC
 */
public final class JTextFieldFormatado extends JTextField {

    private char elimina;
    private int maximoCaracteres = -1;// definição de -1 
// como  valor normal de um textfield sem limite de caracters

    public JTextFieldFormatado() {
        super();
    ...
    public JTextFieldFormatado(int maximo, char tmpElimina) {
        super();
        setEliminaOQue(tmpElimina);
...
// esta linha acima é para remover os caracters inválidos caso o usuário tenha copiado o //conteúdo de algum lugar ou seja com tamanho maior que o definido
    ...
    public char getEliminaOQue() {
        return elimina;
    }

    public void setEliminaOQue(char tmpElimina) {
        this.elimina = tmpElimina;
    }
